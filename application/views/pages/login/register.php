<div class="col-lg-6 col-md-6 col-sm-9 col-10 card bg-light card-body border border-dark border-3 mx-auto my-5 p-3 rounded-4 card-neoraised">
    ...
    <form method="post" action="register_action.php">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="no_hp" name="no_hp" class="form-control fs-3 card-neoraised" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="foto" class="form-label d-block fs-3 mt-3 fw-bold">Foto Profile</label>
            <input type="file" class="form-control card-neoraised fs-5" id="foto" name="foto" accept="image/*" required>
        </div>
