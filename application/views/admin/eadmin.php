        ...
        <div class="col-12 col-lg-7 col-xl-10">
            ...
            <div class="card-neoraised border border-2 border-dark py-3 px-3 rounded-3">
                <div class="card-header">
                    <h3 class="card-title mb-4 text-center fw-bold">Update Data Admin</h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="ubah_data.php" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control card-neoraised" id="ulangi_password" name="ulangi_password" required>
                        </div>
                        <div class="mb-3">
