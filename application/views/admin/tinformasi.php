        ...
        <div class="col-12 col-lg-7 col-xl-10">
            ...
            <div class="card-neoraised border border-2 border-dark py-3 px-3 rounded-3">
                <div class="card-header">
                    <h3 class="card-title mb-4 text-center fw-bold">Tambah Data Informasi</h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="tambah_data.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="admin" class="form-label">Nama Gunung</label>
                            <input type="text" class="form-control card-neoraised" id="admin" name="admin" required>
                        </div>
                        <div class="mb-3">
                            <label for="harga_biaya" class="form-label">Harga Biaya</label>
                            <input type="number" min="0" class="form-control card-neoraised" id="harga_biaya" name="harga_biaya" required>
                        </div>

                        <div class="mb-3">
                            <label for="lokasi" class="form-label">Lokasi</label>
                            <input type="text" class="form-control card-neoraised" id="lokasi" name="lokasi" required>
                        </div>
                        <div class="mb-3">
