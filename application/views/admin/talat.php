        ...
        <div class="col-12 col-lg-7 col-xl-10">
            ...
            <div class="card-neoraised border border-2 border-dark py-3 px-3 rounded-3">
                <div class="card card-header card-neoraised border border-2 border-dark rounded mb-3">
                    <h3 class="card-title mb-4 text-center fw-bold mt-4 text-black">Tambah Data Alat</h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('Admin/tambahData'); ?>" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control card-neoraised border border-2 border-dark text-black" id="nama" name="nama" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="0" class="form-control card-neoraised text-black border border-2 border-dark" id="stok" name="stok" required>
                        </div>
                        <div class="mb-3">
                            <label for="harga_sewa" class="form-label text-black">Harga Sewa</label>
                            <input type="number" min="0" class="form-control card-neoraised text-black border border-2 border-dark" id="harga_sewa" name="harga_sewa" required>
                        </div>
                        <div class="mb-3">
                            <label for="deskripsi" class="form-label text-black">Deskripsi</label>
                            <textarea class="form-control card-neoraised text-black border border-2 border-dark" id="deskripsi" name="deskripsi" rows="4" style="resize: none;" required></textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between">
                            <button type="submit" class="btn btn-neoraised btn-success mb-3 mt-4 btn-md fw-bold border border-2 border-dark">Tambah</button>
